 ...
 * Source: https://raw.githubusercontent.com/apache/incubator-kie-drools/main/kie-dmn/kie-dmn-feel/ref-dmn-feel-builtin-functions.adoc
 *
 * To update: run `pnpm update-builtins`
 *
 * Last updated: 2025-11-06T18:55:49.167Z
 *
 * Based on:
...
export const builtInFunctions: BuiltInFunction[] = [
...

  {
    ...
    description: 'Returns `true` when an element `A` is after an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` meets an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` is met by an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` overlaps an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` overlaps before an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` overlaps after an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` finishes an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` is finished by an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` includes an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` is during an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` starts an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` is started by an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
  ...
  },
  {
    ...
    description: 'Returns `true` when an element `A` coincides with an element `B` and when the relevant requirements for evaluating to `true` are also met.',
    parameters: [
